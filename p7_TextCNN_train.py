...
from data_util import create_vocabulary,load_data_multilabel,get_label,get_vocabulary
import pickle
import h5py
import os
import random
...
def main(_):
    ...
    #vocabulary_word2index, vocabulary_index2word, vocabulary_label2index, vocabulary_index2label = create_vocabulary(FLAGS.training_data_path,FLAGS.vocab_size,FLAGS.name_scope)
    ...
    with tf.Session(config=config) as sess:
        ...
        textCNN=TextCNN(filter_sizes,FLAGS.num_filters,num_classes, FLAGS.learning_rate, FLAGS.batch_size, FLAGS.decay_steps,
                        FLAGS.decay_rate,FLAGS.sentence_len,FLAGS.vocab_size,FLAGS.embed_size,multi_label_flag=FLAGS.multi_label_flag)
        #Initialize Save
